...
const registerUser = asyncHandler (async (req, res) => {
    /*  
        ...
        checking if user already register or exists: username,email
        check for images , check for avatar
        upload them to cloudinary
        create user object - create enatry in db 
...
const loginUser = asyncHandler (async ( req, res ) => {
    ...
    */
    ...
    if (!user) {
        throw new ApiError(404, "User not found or exist");
    }
...
const getUserChannelProfile = asyncHandler ( async (req, res) => {
    ...
    console.log("Channel count : "+getUserChannelProfile);
...
const getWatchHistory =  asyncHandler ( async (req,res) => {
    ...
    console.log("watch Histroy aggregation result : ",user);
...
export { registerUser , loginUser, logoutUser, refreshAccesssToken, getCurrentUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory, changeCurrentPassword, removeFromWatchHistory,clearWatchHistory }